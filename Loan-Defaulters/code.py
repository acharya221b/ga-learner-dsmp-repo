...
# Code starts here
#X_train['int.rate']=X_train['int.rate'].str.replace('\W', '')
...
#X_test['int.rate']=X_test['int.rate'].str.replace('\W', '')
...
# print(X_train.head())
y_train=y_train.map(dict(Yes=1, No=0)).astype(int)
y_test=y_test.map(dict(Yes=1, No=0)).astype(int)
